      ...
      return c.json({
        ...
        items: {
          MANIFEST: {
            ...
            path: "Builds/Fortnite/Content/CloudDir/5UR0XFTlmPSJlqpGpE60LF1pmp5OjQ.manifest", // replace *.manifest with a valid manifest (e.g: RxwT9fhXyJWzLl0WXky5X98eJx9XfQ.manifest)
            additionalDistributions: [],
          },
        },
        assetId: c.req.param("appName"),
