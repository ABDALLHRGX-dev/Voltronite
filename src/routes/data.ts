      ...
      return c.json({
        ...
        items: {
          MANIFEST: {
            ...
            path: "Builds/Fortnite/Content/CloudDir/H52wySE2fj_VVubdtkS2_b3_n1801g.manifest", // replace *.manifest with a valid manifest (e.g: RxwT9fhXyJWzLl0WXky5X98eJx9XfQ.manifest)
            additionalDistributions: [],
          },
        },
        assetId: c.req.param("appName"),
